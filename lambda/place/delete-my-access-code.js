/**
 * @api {DELETE} /places/:place_id/access-restriction Delete Access Code
 * @apiVersion 0.3.1
 * @apiName Delete Access Code
 * @apiGroup PLACE
 * @apiPermission user
 * @apiDescription Delete Access Code
 ...
 * @apiParam {number} access_code_id The id of access code
